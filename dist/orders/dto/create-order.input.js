...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)({ message: 'Product ID este obligatoriu.' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateOrderItemInput.prototype, "productId", void 0);
__decorate([
    (0, graphql_1.Field)(() => graphql_1.Int),
    (0, class_validator_1.IsInt)({ message: 'Cantitatea trebuie să fie un număr întreg.' }),
    (0, class_validator_1.Min)(1, { message: 'Cantitatea minimă este 1.' }),
    (0, class_validator_1.Max)(10_000, { message: 'Cantitatea maximă este 10.000.' }),
...
__decorate([
    (0, graphql_1.Field)(),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)({ message: 'Numele clientului este obligatoriu.' }),
...
__decorate([
    ...
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.MaxLength)(20, { message: 'Maxim 20 de caractere.' }),
    __metadata("design:type", String)
], CreateOrderInput.prototype, "customerPhone", void 0);
__decorate([
    (0, graphql_1.Field)({ nullable: true }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
...
__decorate([
    (0, graphql_1.Field)(() => order_entity_1.OrderStatus, { nullable: true, defaultValue: order_entity_1.OrderStatus.PENDING }),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    ...
    (0, class_validator_1.ArrayMinSize)(1, { message: 'Comanda trebuie să aibă cel puțin un produs.' }),
